...
- 変更は要件チケット（`docs/03`）起点で、[.claude/skills/change-propagate/SKILL.md](.claude/skills/change-propagate/SKILL.md) の手順どおり上流→下流に反映し、[docs/10-traceability.md](docs/10-traceability.md) へ二重記録（マトリクス＋タイムライン）する
- 点検は [.claude/skills/consistency-check/SKILL.md](.claude/skills/consistency-check/SKILL.md)（観点A〜H・read-only既定）。対象は `docs/`
